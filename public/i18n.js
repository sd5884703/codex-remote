...
export const STRINGS = {
 ...
 fillMesh: '填入外出地址',
 meshFilled: '已保存外出\1Tailscale\1地址',
 meshMissing: '尚未检测到 Tailscale 地址。请在电脑完成 Tailscale 后刷新，或手动填写稳定地址（100.x / 魔术 DNS）',
 errServiceDown: '服务未开：电脑上的编码遥控还没运行。请在电脑执行 npm start，或确认已安装「登录后自动启动」。',
 errMeshOffline: ' Tailscale 未在线\1Tailscale 可能未连接。请在手机与电脑上打开 Tailscale\1确认两端在线后重试。',
 errBadAddrOrKey: '地址或配对令牌不对：请检查服务器地址（应为 Tailscale 100.x / 魔术 DNS，不是家里 Wi-Fi）与配对令牌是否一致。',
 },
 en: {
 appName: 'CodexRemote',
 ...
 lanBody: 'Same Wi-Fi as the computer only; not the going-out primary path.',
 ...
 meshMissing: 'No mesh address detected yet. Finish Tailscale on the computer, or manually enter a stable mesh address.',
